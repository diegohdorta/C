...
//gcc -Wall main.cpp -o helloworld $(pkg-config --cflags --libs gstreamer-1.0)
//$(CC) -Wall helloworld.c -o helloworld $(pkg-config --cflags --libs gstreamer-1.0)
...
int main (int argc, char *argv[])
{
  ...
  videotestsrcm   = gst_element_factory_make ("v4l2src", "testsource");
  autovideosinkm = gst_element_factory_make ("glimagesink", "videosink");

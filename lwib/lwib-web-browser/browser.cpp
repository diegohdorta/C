...
int TITLE_LENGTH = 20;
int LIMIT_TAB = 8;
ustring app_name = "Simple, Fast and High Performance iMX Browser";
	...
	: exe_path(path), blacklist(path)
{
	...
	sidebook.append_page(history_scroll, "");
	sidebook.append_page(bookmark_scroll, "");
	...
	save_bookmark_button.set_label("♡");
	history_button.set_label("");
	bookmark_button.set_label("");

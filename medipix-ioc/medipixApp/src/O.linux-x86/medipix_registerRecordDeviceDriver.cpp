...
/* Generated from ../O.Common/medipix.dbd */
...
int medipix_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/ABTLUS/henrique.almeida/code/medipix-ioc";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"medipix_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    medipix_registerRecordDeviceDriver(*iocshPpdbbase);
}
